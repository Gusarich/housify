...
-   `EmulatedHouse.reset` method: PR [#70](https://github.com/Gusarich/housify/pull/70)
-   Housing types such as `ActionKind` are now available in the module exports: PR [#70](https://github.com/Gusarich/housify/pull/70)
